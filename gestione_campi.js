...
function setupSheets() {
  ...
  const config = [
    { name: SHEETS.CAMPI,       headers: ['Nome Campo','Ettari','N. Piante','Varieta Olivo','Anno Impianto','Comune / Localita','Note','Latitudine','Longitudine','Costo Affitto €','Scadenza Affitto'],     color:'#2E7D32' },
